...
class ArenaTeam {
	...
	private $region, $realm, $teamsize, $teamname, $rating;
	private $data;
	private $fields = '';

	
   	function __construct($region, $realm, $teamsize, $teamname, $rating) {
   		$this->region = $region;
   		$this->realm = $realm;
   		$this->size = $teamsize;
		...
		$this->data = $jsonConnect->getArenaTeam($region, $realm, $teamsize, $teamname, $rating, $this->fields);
